...
open class YamlParserCojen<T : Any>(
    ...
    fun mapToObjectList(mapList: List<Map<String, Any>>, innerType: Class<*>) : List<Any> {
        val parser = yamlParser(innerType.kotlin)
        return mapList.map { parser.newInstance(it) }
    }
    ...
    private fun getValueForParameter(param: Parameter, newInstance: MethodMaker, map :Variable? = null): Variable {
        ...
        return when (param.type) {
            ...
            List::class.java -> {
                ...
                newInstance.invoke("mapToObjectList", list, innerType)
            }
            else -> {
